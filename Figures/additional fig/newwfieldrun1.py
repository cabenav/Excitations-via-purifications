...
plt.rc('font', size=15)  
for i in range(nf-1):
   plt.plot(FI1, eigen[:,i],'b-', mfc='none')
plt.plot(FI1, eigen[:,nf-1],'b-', mfc='none',label='exact')
...
pickle.dump(eigen, open( "list7_3a.p", "wb" ) )
pickle.dump(eigennum, open( "list7_3b.p", "wb" ) )
