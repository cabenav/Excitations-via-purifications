...
for i in range(nf-1):
   ...
   plt.plot(FI1, eigennumor1[:,i],'bx',mfc='none')
plt.plot(FI1, eigenor[:,nf-1],'r-', mfc='none',label='exact')
plt.plot(FI1, eigennumor[:,nf-1],'ko', mfc='none',label='$w_{s,3}=0.4$')
plt.plot(FI1, eigennumor1[:,nf-1],'bx', mfc='none',label='$w_{s,3}=0.48$')
